...
// Entrada
const valor = Number(question("Valor da mercadoria:"));

// Processamento
const parcela = Math.floor(valor / 3);
const entrada = valor - 2 * parcela;

// Saida
console.log("O valor da entrada é", entrada);
console.log("E o valor das duas parcelas é de ", parcela);